...
```
feat(gh-classify): add priority label output to post-classify script

fix(#42): correct dispatch event payload for scribe agent

refactor(harness): consolidate review harness overrides

chore(ci): bump fullsend action version

docs: add scribe agent usage guide
```
